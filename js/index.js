...
async function convertFiles() {
    ...
    try {
        ...
        for (const file of filesToConvert) {
            ...
            const gifBlob = await convertToGif(imgElement);
            convertedFiles.push(gifBlob);
        }
...
function convertToGif(imgElement) {
...
function createSingleDownloadLink(blob) {
    ...
    downloadButton.download = `${originalFilename}_prepphint.com.gif`;
}
...
function createDownloadLink(blobs) {
    ...
    blobs.forEach((blob, index) => {
        ...
        zip.file(`${originalFileName}_prepphint.com.gif`, blob);
    });
